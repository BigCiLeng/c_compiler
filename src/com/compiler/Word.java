...
public class Word {
	...
	public final static String INT_CONST = "整型";
	public final static String CHAR_CONST = "字符";
	public final static String BOOL_CONST = "布尔";
	public final static String IDENTIFIER = "标志符";
	public final static String BOUNDARYSIGN = "界符";
	public final static String END = "结束符";
	public final static String UNIDEF = "未知";
